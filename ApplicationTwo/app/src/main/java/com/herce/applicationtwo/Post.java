...
public class Post extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        content = (WebView)findViewById(R.id.contenido);
        ...
        String url = "http://ubiquitous.csf.itesm.mx/~pddm-1021150/CMS/wp-json/wp/v2/posts/"+id+"?fields=title,content";
