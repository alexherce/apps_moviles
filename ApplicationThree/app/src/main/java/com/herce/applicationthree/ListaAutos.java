...
public class ListaAutos extends ListFragment {
    ...
    String url = "http://ubiquitous.csf.itesm.mx/~pddm-1021150/content/parcial1/02022017/servicio.autos.php?count=5";
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = getActivity().getLayoutInflater()
                        .inflate(R.layout.layout_listacategorias, null);
            }
            ...
            nameTextView.setText(c.getAuto());
